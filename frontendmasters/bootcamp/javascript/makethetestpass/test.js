function addTwoToEveryNumberInTheList (list) {
  ...
  function findLargestNumber(list) {
      ...
      //in this case, i = 1 because largestNumber already has the list[0] and dont need to be verificated;
  ...
  function getAverageAge(list) {
      ...
      for (let i = 0; i < list.length; i++){
          //newList.push(list[i].age)
  
          ageTotal = ageTotal + parseInt(list[i].age)
  
      }
  
      ageAvg = ageTotal/list.length
